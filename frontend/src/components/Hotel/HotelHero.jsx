  ...
  return (
    <div className="relative z-0">
      <video
        ...
        type="video/mp4"
      ></video>
      <div className="relative container z-10 bg-opacity-50 bg-black py-4 ">
        <div className="container mx-auto py-12 text-white">
          <div className="text-center mb-8">
            <span className="block text-sm text-white">Our hotels</span>
            <h1 className="text-4xl font-bold text-white">Search your hotels</h1>
          </div>
