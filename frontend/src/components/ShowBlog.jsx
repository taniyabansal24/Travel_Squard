  ...
  return (
    <section className=" py-14 md:py-24 text-stone-800 bg-gray-100  dark:text-black overflow-hidden">
      <div className="border flex flex-col justify-center items-center">
        <div className="grid grid-cols- justify-center px-2 md:px-8 xl:px-28">
        ...
        <div className="container grid grid-cols-12 lg:grid-cols-9 mt-12 gap-4 py-4 bg-gray-100 mx-auto">
