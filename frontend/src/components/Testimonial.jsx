...
const Testimonial = () => {
  ...
  return (
    <section className="py-14 sm:px-5 md:py-24 overflow-hidden bg-gray-100  ">
      <div className="container shadow-lg sm:border sm:px-6 md:px-8 xl:px-28 mx-auto bg-white">
