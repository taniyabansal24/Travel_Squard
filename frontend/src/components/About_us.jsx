...
const About_us = () => {
  return (
    ...
    <div className=" flex flex-col justify-between md:flex-row container ">
        <div className="text w-full md:w-3/6 my-12">
        ...
        <div className="images w-full md:w-3/6 my-12 pl-4 flex flex-col justify-between items-center gap-5 md:gap-0 md:flex-row ">
            ...
            <div className="img3 w-full h-36 md:w-72 md:h-96 rounded-lg overflow-hidden my-0 relative">
